...
public final class leg_control_command_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public leg_control_command_lcmt()
    {
        ...
        tau_des = new float[16];
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x09de2bbd49b05e39L;
    ...
    public lcmtypes.leg_control_command_lcmt copy()
    {
        ...
        outobj.tau_des = new float[(int) 16];
        System.arraycopy(this.tau_des, 0, outobj.tau_des, 0, 16); 
        return outobj;
    }
