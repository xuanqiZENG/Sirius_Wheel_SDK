...
#ifndef __imu_lcmt_hpp__
#define __imu_lcmt_hpp__
...
int imu_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int imu_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t imu_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* imu_lcmt::getTypeName()
{
    return "imu_lcmt";
}

int imu_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int imu_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t imu_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x39b734434bcce8e2LL;
